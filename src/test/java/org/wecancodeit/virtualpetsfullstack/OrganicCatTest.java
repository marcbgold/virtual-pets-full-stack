...
public class OrganicCatTest {
	...
	public void tickShouldRaiseOrLowerValuesBy10() {
		...
		assertThat(underTest.getHungerLevel(), is(65));
		assertThat(underTest.getThirstLevel(), is(65));
		assertThat(underTest.getHappinessLevel(), is(55));
		assertThat(underTest.getTirednessLevel(), is(65));
		assertThat(underTest.getWasteLevel(), is(65));
	}

...
public class VirtualPetsAmokApp {
	...
	//
	// System.out.println("Welcome to Flexible Capacity Shelter #32098-AXA-8 for
	// Virtual Pet Units.");
	// System.out.println("Thank you for volunteering your time here.");
	// System.out.println("Please enter your name, so that we can address you
	// properly.");
	...
	// } else if (entry.getValue().getWasteLevel() > 2) {
	// System.out.println(entry.getKey().getName() + "'s cage is abjectly
	// disgusting. Stop ignoring it and clean it already.");
	// }
	// }
	//
	// if (myShelter.checkIfFloorIsDirty()) {
	// System.out.println("Someone went on the floor. Gross. Clean that up
	// immediately.");
	// System.out.println();
	// }
	//
	...
	// System.out.println("The food bowls are all already full. No need to put out
	// more food right now.");
	...
	// }
	//
	// System.out.println("You refilled the food bowls. Now the organic pets will
	// have plenty to eat.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	...
	//
	// if (actionResult.equals("no need")) {
	// System.out.println("The water bowls are all already full. No need to put out
	...
	// }
	//
	// System.out.println("You refilled the water bowls. Now the organic pets will
	...
	//
	// System.out.println("You cleaned all the cages, regardless of whether or not
	// they needed it. You are very fastidious, human unit.");
	// System.out.println("Now the organic pets who utilize those cages will not see
	// their health levels drop.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "4":
	...
	//
	// if (actionResult.equals("no need")) {
	// System.out.println("The litter boxes are all already clean. No need to scoop
	// them out right now.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// continue;
	// }
	//
	// System.out.println("You scooped out the litter boxes. Proper hygiene is
	// important for maintaining proper organic cat unit health levels.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "5":
	...
	// }
	// System.out.println();
	// System.out.println("Please enter the name of the pet you would like to play
	// with:");
	...
	// System.out.println(nameInput + " is too tired to play with you right now. Try
	// again later.");
	// } else if (actionResult.equals("too hungry")) {
	// System.out.println(nameInput + " is too hungry to play with you right now.
	// Try again later.");
	// } else if (actionResult.equals("oil too low")) {
	// System.out.println(nameInput + "'s oil levels are too low to play with you
	// right now. Try again later.");
	// } else if (actionResult.equals("charge too low")) {
	// System.out.println(nameInput + "'s battery levels are too low to play with
	// you right now. Try again later.");
	// } else {
	// System.out.println(nameInput + " is too unhealthy to play with you right now.
	// You should really address that promptly.");
	// }
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// continue;
	...
	//
	// System.out.println();
	// System.out.println("You played with " + nameInput + ". Quantifiable fun
	...
	//
	// System.out.println("You walked all the dogs. Now they are happier, and the
	// organic ones will not make a mess of their cages for the time being.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "7":
	...
	//
	// System.out.println("You oiled all the robots. Now they will be able to
	// function with maximum mobility.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "8":
	...
	//
	// System.out.println("You recharged all the robots. This is good. No robot
	// should have to put up with an empty battery.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "9":
	// typeInput = "";
	// System.out.println("Please choose the type of the pet you would like to
	// admit:");
	...
	// }
	//
	// System.out.println("Please choose the species of the pet you would like to
	// admit:");
	...
	// }
	//
	// System.out.println("Please enter the name of the pet you would like to
	// admit:");
	// nameInput = input.nextLine().trim();
	// if (nameInput.equals("")) {
	...
	// System.out.println("Names over 15 characters screw up the roster formatting.
	// Try a shorter one.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// continue;
	...
	// System.out.println("It would be too confusing if two pets had the same name.
	// Try a different one.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// continue;
	...
	//
	// System.out.println(nameInput + " has successfully been admitted to the
	// shelter.");
	...
	//
	// System.out.println(nameInput + " has successfully been adopted out to a new
	// home.");
	// System.out.println("Goodbye, " + nameInput + "! Continue to provide optimum
	// performance in a new physical location!");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// case "11":
	// System.out.println("Please enter the name of the pet whose description you
	// would like to see:");
	// nameInput = input.nextLine().trim();
	// System.out.println();
	//
	...
	// selectedPet.getDescription());
	// System.out.println();
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// continue;
	// case "12":
	// System.out.println("It is possible to just stare at the pets if you feel like
	// it.");
	// System.out.println("Do not stare for too long, though. You have work to do,
	// human.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	...
	//
	// System.out.println("You cleaned the floor. Now the organic pets will not get
	// sick from stepping in their own filth.");
	// System.out.println("This is your fault for not cleaning the cages and litter
	// boxes sooner, you know. Don't let it happen again.");
	// System.out.println("Press enter to continue.");
	// input.nextLine();
	// break;
	// default:
	...
	// System.out.println("Critical failure. Your inattentiveness has allowed a pet
	// to die.");
	// System.out.println("Now Virtual Animal Protection Services will come and shut
	// down this shelter.");
	// System.out.println("You are a terrible person. I hope this knowledge will
	// haunt you for the remainder of your organic lifespan.");
	// System.out.println("Goodbye.");
	// } else {
	// System.out.println("Goodbye, " + yourName + ". Thank you for volunteering.
	// Please come back later and help out again.");
	// }
	// input.close();
	//
	// }
